...
public class PersonalSanitarioData {
    ...
    public static void generarDatosPersonalSanitario() {
        ...
        dataPersonalSanitario.add(new PersonalSanitario("Eva", "López", "Fernández", "34567890C", new Date(1990 - 1900, Calendar.MARCH, 5), 28017, "Plaza España 333", 633445566, new Unidades("Consultas externas", "Cirugía General"), Turno.NOCTURNO, 6000));
        ...
        dataPersonalSanitario.add(new PersonalSanitario("Javier", "Martínez", "López", "67890123F", new Date(1995 - 1900, Calendar.JUNE, 8), 28020, "Calle Real 666", 699001122, new Unidades("Consultas externas", "Oncología"), Turno.NOCTURNO, 5500));
        ...
        dataPersonalSanitario.add(new PersonalSanitario("Laura", "Sánchez", "Gómez", "90123456I", new Date(1979 - 1900, Calendar.SEPTEMBER, 10), 28023, "Paseo del Parque 999", 633445566, new Unidades("Consultas externas", "Traumatología"), Turno.NOCTURNO, 6000));
        ...
        dataPersonalSanitario.add(new PersonalSanitario("Carlos", "Sánchez", "Fernández", "98765432C", new Date(1988 - 1900, Calendar.MARCH, 5), 28003, "Plaza Mayor 789", 600112233, new Unidades("Unidades especializadas", "Enfermedades Cardiovasculares"), Turno.NOCTURNO, 6000));
        ...
        dataPersonalSanitario.add(new PersonalSanitario("Pedro", "Díaz", "Gómez", "34567890F", new Date(1985 - 1900, Calendar.AUGUST, 10), 28006, "Avenida del Sol 333", 688990011, new Unidades("Unidades especializadas", "Enfermedades Cardiovasculares"), Turno.NOCTURNO, 5500));
